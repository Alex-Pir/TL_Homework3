...
namespace Lesson.Libs.Common.Types.Extensions.Test
{
    ...
    public class DateRangeExtensionsTest
    {
        ...
        // Alternate
        public static IEnumerable<object[]> DateRangeExtensions_Intersect_HasIntersection_ReturnsResultDateRange_Data => new List<object[]>
        {
            new object[]
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings, DateRange expectedDateRange) )
                ("SameDateRanges",
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 9, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 9, 12, 0, 0 ) ),
                true,
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 9, 12, 0, 0 ) ))
            },
            ...
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings, DateRange expectedDateRange) )
                ("SameDateRangeMoments",
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 12, 0, 0 ) ),
                true,
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 12, 0, 0 ) ))
            },
            ...
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings, DateRange expectedDateRange) )
                ("DateRangesShareTwoHours",
                new DateRange( new DateTime( 2019, 7, 7, 12, 0, 0 ), new DateTime( 2019, 7, 8, 14, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 9, 12, 0, 0 ) ),
                true,
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 14, 0, 0 ) ))
            },
            new object[]
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings, DateRange expectedDateRange) )
                ("DateRangesShareTwoDays",
                new DateRange( new DateTime( 2019, 7, 7, 12, 0, 0 ), new DateTime( 2019, 7, 13, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 11, 12, 0, 0 ), new DateTime( 2019, 7, 16, 12, 0, 0 ) ),
                true,
                new DateRange( new DateTime( 2019, 7, 11, 12, 0, 0 ), new DateTime( 2019, 7, 13, 12, 0, 0 ) ))
            },
            new object[]
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings, DateRange expectedDateRange) )
                ( scenario: "FirstDateRangeContainsSecond",
                firstDateRange: new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 12, 12, 0, 0 ) ),
                secondDateRange: new DateRange( new DateTime( 2019, 7, 9, 12, 0, 0 ), new DateTime( 2019, 7, 10, 12, 0, 0 ) ),
                shouldIncludeEndings: true,
                expectedDateRange: new DateRange( new DateTime( 2019, 7, 9, 12, 0, 0 ), new DateTime( 2019, 7, 10, 12, 0, 0 ) ))
            },
            new object[]
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings, DateRange expectedDateRange) )
                (scenario: "FirstDateRangeContainsSecondWithoutEndings",
                firstDateRange: new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 12, 12, 0, 0 ) ),
                secondDateRange: new DateRange( new DateTime( 2019, 7, 9, 12, 0, 0 ), new DateTime( 2019, 7, 10, 12, 0, 0 ) ),
                shouldIncludeEndings: false,
                expectedDateRange: new DateRange( new DateTime( 2019, 7, 9, 12, 0, 0 ), new DateTime( 2019, 7, 10, 12, 0, 0 ) ))
            },
        };

        [DataTestMethod]
        [DynamicData( nameof( DateRangeExtensions_Intersect_HasIntersection_ReturnsResultDateRange_Data ) )]
        public void DateRangeExtensions_Intersect_HasIntersection_ReturnsResultDateRange(
            (string scenario,
            DateRange firstDateRange,
            DateRange secondDateRange,
            bool shouldIncludeEndings,
            DateRange expectedDateRange) data )
        {
            // Arrange
            (string scenario,
            DateRange firstDateRange,
            ...
            // Act
            DateRange? result = firstDateRange.Intersect( secondDateRange, shouldIncludeEndings );

            // Assert
            Assert.IsNotNull( result );
            Assert.AreEqual( expectedDateRange.StartDateTime, result.Value.StartDateTime );
            Assert.AreEqual( expectedDateRange.EndDateTime, result.Value.EndDateTime );
        }

        // Alternate
        public static IEnumerable<object[]> DateRangeExtensions_Intersect_NoIntersection_ReturnsNull_Data => new List<object[]>
        {
            new object[]
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings) )
                ("SameDateMomentsWithoutEndings",
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 12, 0, 0 ) ),
                false)
            },
            ...
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings) )
                ("SameDateNoSharedSpanAndWithEndings",
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 8, 14, 0, 0 ), new DateTime( 2019, 7, 8, 15, 0, 0 ) ),
                true)
            },
            new object[]
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings) )
                ("DateRangesSgareOneMomentWithoutEndings",
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 9, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 8, 12, 0, 0 ) ),
                false)
            },
            ...
            {
                ( (string scenario, DateRange firstDateRange, DateRange secondDateRange, bool shouldIncludeEndings) )
                ("FollowingDateRangesWithoutEndings",
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 9, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 9, 12, 0, 0 ), new DateTime( 2019, 7, 10, 12, 0, 0 ) ),
                false)
            },
            new object[]
            {
                ...
                ("NoIntersection",
                new DateRange( new DateTime( 2019, 7, 8, 12, 0, 0 ), new DateTime( 2019, 7, 9, 12, 0, 0 ) ),
                new DateRange( new DateTime( 2019, 7, 10, 12, 0, 0 ), new DateTime( 2019, 7, 11, 12, 0, 0 ) ),
                false)
            },
        };

        [DataTestMethod]
        [DynamicData( nameof( DateRangeExtensions_Intersect_NoIntersection_ReturnsNull_Data ) )]
        public void DateRangeExtensions_Intersect_NoIntersection_ReturnsNull(
            (string scenario,
            DateRange firstDateRange,
            DateRange secondDateRange,
            bool shouldIncludeEndings) data )
        {
            // Arrange
            (string scenario,
            DateRange firstDateRange,
        ...
        [TestMethod]
        public void DateRangeExtensions_Split_NegativeChunkSize_ReturnsEmptyCollection()
        {
            // Arrange
            DateRange dateRange = new DateRange( new DateTime( 2019, 7, 8 ), new DateTime( 2019, 7, 9 ) );

            // Act
            IEnumerable<DateRange> actual = dateRange.Split( +1 );

            // Assert
            Assert.IsFalse( actual.Any(), "For negative chunkSize collection is not empty" );
        }

        [TestMethod]
        public void DateRangeExtensions_Split_NeutralChunkSize_ReturnsEmptyCollection()
        {
            // Arrange
            DateRange dateRange = new DateRange( new DateTime( 2019, 7, 8 ), new DateTime( 2019, 7, 9 ) );

            // Act
            IEnumerable<DateRange> actual = dateRange.Split( 0 );

            // Assert
            Assert.IsFalse( actual.Any(), "For neutral chunkSize collection is not empty" );
        }

        [TestMethod]
        public void DateRangeExtensions_Split_ChunkSizeLargerThenDateRange_ReturnsOneSameDateRange()
        {
            // Arrange
            DateRange dateRange = new DateRange( new DateTime( 2019, 7, 8 ), new DateTime( 2019, 7, 9 ) );

            // Act
            IEnumerable<DateRange> actual = dateRange.Split( 10 );

            // Assert
            Assert.AreEqual( 1, actual.Count(), "Number of elements collection are not equal one" );
            Assert.AreEqual( dateRange, actual.First(),  "Actual DateRange are not equal original DateRange" );
        }

        [TestMethod]
        public void DateRangeExtensions_Split_ChunkSizeSmallerThenDateRange_ReturnsCollectionSplitedDateRanges()
        {
            // Arrange
            DateRange dateRange = new DateRange( new DateTime( 2019, 7, 8 ), new DateTime( 2019, 7, 12 ) );

            // Act
            IEnumerable<DateRange> actualSomeDateRanges = dateRange.Split( 2 );

            // Assert
            Assert.AreEqual( 3, actualSomeDateRanges.Count(), "Number of elements collection are not equal 3" );
            Assert.IsTrue( actualSomeDateRanges.ToList()[0].EqualTo( new DateRange( new DateTime( 2019, 7, 8 ), new DateTime( 2019, 7, 9 ) ) ), "Actual first DateRange are not equal first day in original DateRange" );
            Assert.IsTrue( actualSomeDateRanges.ToList()[1].EqualTo( new DateRange( new DateTime( 2019, 7, 10 ), new DateTime( 2019, 7, 11 ) ) ), "Actual second DateRange are not equal second day in original DateRange" );
            Assert.IsTrue( actualSomeDateRanges.ToList()[2].EqualTo( new DateRange( new DateTime( 2019, 7, 12 ), new DateTime( 2019, 7, 12 ) ) ), "Actual third DateRange are not equal third day in original DateRange" );
        }

        [TestMethod]
        public void DateRangeExtensions_AsMidnightDateRange_DateRangeWithTimes_ReturnsDateRangeWithoutTimes()
        {
            // Arrange
            DateRange dateRange = new DateRange( new DateTime( 2019, 7, 8, 13, 0, 0 ), new DateTime( 2019, 7, 12, 7, 0, 0 ) );

            // Act
            DateRange result = dateRange.AsMidnightDateRange();

            // Assert
            Assert.AreEqual( dateRange.StartDate, result.StartDateTime );
            Assert.AreEqual( dateRange.EndDate, result.EndDateTime );
        }
    }
}
